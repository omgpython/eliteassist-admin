            ...
            <div class="col-lg-8 col-md-6 d-flex flex-column  ">
              ...
              <div class="card mb-3 ms-5">
                ...
                <div class="card-body">
                  ...
                  <form class="row g-3 needs-validation" action="{{route('banners.store')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="col-12">
                      ...
                      <div class="input-group has-validation">
                        ...
                        <input type="text" name="Btitle" class="form-control" id="yourUsername" placeholder="Enter Service Name" required>
