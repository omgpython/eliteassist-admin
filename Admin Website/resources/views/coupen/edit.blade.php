            ...
            <div class="col-lg-8 col-md-6 d-flex flex-column  ">
              ...
              <div class="card mb-3 ms-5">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    <h5 class="card-title text-center pb-0 fs-4">Edit Coupen</h5>
                  </div>

                  <form class="row g-3 needs-validation" action="{{route('coupens.update',$coupen->id)}}" method="POST" enctype="multipart/form-data">
                    @method('PUT')
                    @csrf
                    <div class="col-12">
                      ...
                      <div class="input-group has-validation">
                        ...
                        <input type="text" name="ccode" value="{{$coupen->coupen_code}}" class="form-control" id="yourUsername" placeholder="Enter Coupen-Code">
                    ...
                    <div class="col-12">
                        ...
                        <div class="input-group has-validation">
                          ...
                          <textarea name="cdescription" class="form-control" id="yourUsername" placeholder="Enter Coupen-Discription">{{$coupen->coupen_descreption}}</textarea>
                          <span class="text-danger">
                            @error('cdescription')
                              {{$message}}
                            @enderror
                          </span> 
                          <div class="invalid-feedback">Please Enter coupen_Discription</div>
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        ...
                        <div class="input-group has-validation">
                          ...
                          <input type="text" name="cdiscount" value="{{$coupen->coupen_discount}}" class="form-control" id="yourUsername" placeholder="Enter Coupen-Discount">
                          <span class="text-danger">
                            @error('cdiscount')
                              {{$message}}
                            @enderror
